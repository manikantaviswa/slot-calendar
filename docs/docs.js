...
angular
  ...
  .controller('ExamplesCtrl', function($http, $rootScope, $compile, $q, $location, $ocLazyLoad, plunkGenerator, abcMoment) {
    ...
    vm.editActiveExample = function() {
      plunkGenerator(angular.version.full, '3', '2', abcMoment.version, helpers, vm.activeExample);
    };
